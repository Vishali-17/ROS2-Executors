...
private:
    ...
    void callbackTimer1()
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Hello From Timer:1");
    }

    void callbackTimer2()
    {
        std::this_thread::sleep_for(2000ms);
        RCLCPP_INFO(this->get_logger(), "Hello From Timer:2");
    }

    void callbackTimer3()
    {
        std::this_thread::sleep_for(2000ms);
        RCLCPP_INFO(this->get_logger(), "Hello From Timer:3");
    }
...
private:
    ...
    {
        std::this_thread::sleep_for(2000ms);
        RCLCPP_INFO(this->get_logger(), "Hello From Timer:4");
    }

    void callbackTimer5()
    {
        std::this_thread::sleep_for(2000ms);
        RCLCPP_INFO(this->get_logger(), "Hello From Timer:5");
    }
